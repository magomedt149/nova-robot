...
[Открыть ручную панель на сайте](./index.html) или [запустить ноутбук в Google Colab](https://colab.research.google.com/github/magomedt149/nova-robot/blob/main/blender-colab/TUMSOEV_Blender_WanGP_Studio.ipynb).
