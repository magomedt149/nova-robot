const MOTION_VERSION = 'v27';
const CACHE = 'tumsoev-motion-vfx-studio-v27-multitrack-audio';
const ASSETS = [
  '/motion-studio/',
...
self.addEventListener('activate', event => {
  event.waitUntil((async () => {
    ...
    // service-worker activation; the next navigation is controlled by v27.
...
self.addEventListener('fetch', event => {
  ...
  // The v27 cache is only the offline fallback and is refreshed by successful fetches.
  event.respondWith(
